/*!
  ...
  git+ssh://git@github.com/leafygreen/backbone-bootstrap-modals.git
...
BackboneBootstrapModals.BaseModal = Backbone.View.extend({
    ...
    constructor: function(opts) {
		...
		// this.bodyViewOptions = {parentView:opts.parentView};
		// console.log("CONSTRUCTOR:"+opts.parentView.lol());
    },
